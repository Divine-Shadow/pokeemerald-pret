...
- Gameplay/Items: Replace map pickup EV boosters with Pretty Feathers, Nuggets, or the moved Flying Gem because EVs are disabled (commit a0f119008a).
- Docs/Items: Stop recommending EV feathers as low-tier field rewards while EVs are disabled (commit a0f119008a).
- Gameplay/Charm: Suppress passive Extinction Charm walking and surfing popups while keeping deliberate encounter feedback (commit a0f119008a).
- Gameplay/Starters: Let Shiny Charm rolls apply to starter Pokemon without changing ordinary gift Pokemon shiny behavior (commit a0f119008a).
- Gameplay/Events: Persist Rusturf Tunnel Peeko rescue object state after the rescue sequence (commit a0f119008a).
- Dialogue: Restore Birch intro speech to the Birch-specific Pokemon line (commit a0f119008a).
