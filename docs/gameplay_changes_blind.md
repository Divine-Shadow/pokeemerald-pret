...
- Rare Candies, the reusable Training Kit, Master Balls, and Max Repels are available from the player's PC. The Highlander Charm and Extinction Charm start in the Key Items pocket and are off until used.
