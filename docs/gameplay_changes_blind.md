# Blind-Friendly Discovery Changes

This file contains gameplay changes that may affect routing or discoveries. Read only if you want those details before finding them in play.

## Early Resources

- Rare Candies, Training Candies, Master Balls, Max Repels, and the Skateboard are available from the player's PC. The Highlander Charm and Extinction Charm start in the Key Items pocket and are off until used.
...
- Exact first-pass TM placements are documented in [tm_field_locations.md](tm_field_locations.md).

## Held Item Locations

- Exact first-pass held-item placements and shop changes are documented in [held_item_reward_locations.md](held_item_reward_locations.md).

## Low-Tier Field Rewards

- Exact first-pass low-tier field reward placements are documented in [low_tier_field_rewards.md](low_tier_field_rewards.md).
