...
- Opposing trainers do not use non-held combat aid items such as X items, healing items, status cures, revives, or PP restorers. Some battles or areas can also disable those combat aid items for the player while still allowing Poke Balls under the normal catching rules.
...
- Pressing B toggles Running Shoes movement on foot instead of requiring B to be held. The Skateboard is a Key Item that passively upgrades toggled Running Shoes movement to a faster speed below full bike movement while preserving normal running restrictions.
...
- Pokemon Centers and the Pokemon League lobby now have Condition Coaches who can intentionally prepare regular poison, burn, paralysis, a one-turn Rest-style wakeup sleep, or clear status from conscious non-Egg party Pokemon. On the Coach's party screen, A prepares the highlighted Pokemon and START offers to prepare every eligible party member at once; whole-party preparation asks for confirmation, skips Eggs and fainted Pokemon, and summarizes relevant status abilities and cautions. Applying a condition replaces the Pokemon's current status. Poison and clear status are available immediately; burn requires 2 badges, paralysis requires 4 badges, and Rest-wake requires 6 badges.
...
- Enemy trainer Pokemon no longer have EV investment.
...
- One old Route 126 trainer encounter has been retired to make room for future recurring journey NPC work.
