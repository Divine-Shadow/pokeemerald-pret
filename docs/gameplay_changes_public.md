...
- The Skateboard is a Key Item that passively upgrades B-button Running Shoes movement to a faster speed below full bike movement while preserving normal running restrictions.
