...
#define HOLD_BUTTON_ADVANCES_TEXT    TRUE    // If TRUE, script message waits accept held A_BUTTON or B_BUTTON instead of requiring a fresh press after text finishes.
