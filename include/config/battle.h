...
#define B_TRAINERS_USE_BAG_ITEMS    FALSE      // If TRUE, opposing trainers can use their configured non-held battle items such as Potions or X items.
...
#define B_OVERWORLD_FOG                 0 // Overworld Fog is visual-only and has no battle effect. In Gen8+, overworld Fog summons Misty Terrain in battle. In Gen4 only, overworld Fog summons the unique fog weather condition in battle.
