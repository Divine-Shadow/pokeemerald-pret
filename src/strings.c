...
const u8 gText_HighlanderCharmOn[] = _("The Highlander Charm has been\nturned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_HighlanderCharmOff[] = _("The Highlander Charm has been\nturned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_BoundaryCharmOn[] = _("The Extinction Charm has been\nturned on.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SkateboardPassive[] = _("Press the B Button to toggle\nSkateboard-speed running.{PAUSE_UNTIL_PRESS}");
